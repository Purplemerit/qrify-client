        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full px-4 py-2.5 text-sm bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-200 transition-all duration-200 disabled:bg-blue-400 disabled:cursor-not-allowed transform hover:translate-y-[-1px] hover:shadow-lg disabled:transform-none disabled:shadow-none mt-6"
            >
          ...
          <div className="mt-5">
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              <button
                className="px-3 py-2.5 border border-gray-300 rounded-lg hover:bg-gray-50 transition-all duration-200 text-xs font-medium text-gray-700 flex items-center justify-center gap-2 hover:border-gray-400"
                disabled={loading}
              >
