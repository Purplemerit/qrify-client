  ...
  if (compact) {
    return (
      <div className="space-y-6">
        ...
        <div className="space-y-3">
          <h4 className="text-md font-medium">Shape</h4>
        ...
        <div className="space-y-3">
          <h4 className="text-md font-medium">Quality</h4>
          <div className="grid grid-cols-4 gap-2">
            {qualityOptions.map((quality) => (
              ...
              >
                <div className="text-xs font-semibold mb-1">{quality.name}</div>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border-2 border-gray-100 p-6 shadow-sm hover:shadow-lg transition-all duration-300 hover-lift group">
        ...
        <p className="text-sm text-gray-600 mb-6 leading-relaxed">
          Choose from various frame designs to make your QR code stand out and
          provide visual context for scanning. Frames help users understand the
          purpose of your QR code at a glance.
        </p>
      ...
      <div className="bg-white rounded-xl border-2 border-gray-100 p-6 shadow-sm hover:shadow-lg transition-all duration-300 hover-lift group">
        ...
        <p className="text-sm text-gray-600 mb-6 leading-relaxed">
          ...
          Choose from classic squares to rounded corners, dots, or circles for
      ...
      <div className="bg-white rounded-xl border-2 border-gray-100 p-6 shadow-sm hover:shadow-lg transition-all duration-300 hover-lift group">
        ...
        <p className="text-sm text-gray-600 mb-6 leading-relaxed">
          Add recognizable icons like WhatsApp, location, link, or WiFi symbols
          to instantly communicate your QR code's purpose and increase scan
          rates.
        </p>
      ...
      <div className="bg-white rounded-xl border-2 border-gray-100 p-6 shadow-sm hover:shadow-lg transition-all duration-300 hover-lift group">
        ...
        <p className="text-sm text-gray-600 mb-6 leading-relaxed">
          ...
          readable even when partially damaged, dirty, or obscured. Choose based
          on your usage environment.
        </p>
